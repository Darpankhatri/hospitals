...
$favicon = App\Models\logo::where('name','favicon')->where('is_active',1)->first(); ?>
<!DOCTYPE html>
<html lang="en">
    
<!-- Mirrored from coderthemes.com/codefox/layouts/auth-confirm-mail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Aug 2022 15:35:00 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Confirm Email | Codefox - Responsive Admin Dashboard Template</title>
                        ...
                        <div class="card shadow-none">
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="index.html" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="{{ asset($logo->image) }}" alt="" height="22">
                                            </span>
                                        </a>
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <a href="{{ route('home') }}" class="btn w-100 btn-primary waves-effect waves-light mt-3">Back to Home</a>
                                </div>
