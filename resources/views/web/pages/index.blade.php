                            ...
                            <div class="client-item">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="client-info d-flex align-items-center">
                                        <img src="{{ asset('web/images/client/client-1.jpg') }}" alt="Image">
                                        <div class="ms-3">
                                            <h3>Ralph Gonzales</h3>
                                            <span>Patient</span>
                                        </div>
                                    </div>
                                    <img src="{{ asset('web/images/client/quat.svg') }}" class="quat" alt="Image">
                                </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog">
                            <a href="blog-details.php">
                                <img src="{{ asset('web/images/blog/blog-1.jpg') }}" alt="Image">
                            </a>

                            <div class="blog-content">
                                <a href="blog-details.php" class="tag">Special</a>
                                ...
                                <h3>
                                    <a href="blog-details.php">How to live a healthy life without pain or disease</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog">
                            <a href="blog-details.php">
                                <img src="{{ asset('web/images/blog/blog-2.jpg') }}" alt="Image">
                            </a>

                            <div class="blog-content">
                                <a href="blog-details.php" class="tag">Health</a>
                                ...
                                <h3>
                                    <a href="blog-details.php">Why would I give up all bad habits to stay good</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog">
                            <a href="blog-details.php">
                                <img src="{{ asset('web/images/blog/blog-3.jpg') }}" alt="Image">
                            </a>

                            <div class="blog-content">
                                <a href="blog-details.php" class="tag">First Aid</a>
                                ...
                                <h3>
                                    <a href="blog-details.php">Everyone's home must have a first aid kit</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="knock-us-btn">
                            <a href="appointment.php" class="default-btn active">Book an appointment</a>
                        </div>
                    </div>
                </div>
            </div>
